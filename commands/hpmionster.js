...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('reducehealthmonster')
        .setDescription('Reduce the health of your monster')
        .addIntegerOption(option => 
            option.setName('damage')
                .setDescription('Damage to reduce from your monster\'s health')
                .setRequired(true)
        ),
    ...
    async execute(interaction) {
        ...
        try {
            ...
            monster.health.current = Math.max(monster.health.current - damage, 0); // Ensure health doesn't go below 0
