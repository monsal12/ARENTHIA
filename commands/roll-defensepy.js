...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            // Roll untuk Physical Defense
            const rolledPhysicalDefense = roll(roleStats.physical_defense);
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    { name: 'Physical Defense Roll', value: `${rolledPhysicalDefense}`, inline: true }
                )
